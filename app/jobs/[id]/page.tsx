  ...
  async function handleProofUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const { error: dbError } = await supabase
        ...
        .update({ 
          proof_url: publicUrl,
          proof_status: 'Needs Approval',
          status: 'Proofing' // Auto-move workflow
        })
        .eq('id', id);
          ...
          <Section title="Proof Management">
            {job.proof_url ? (
              ...
              <div style={{ textAlign: "center", padding: "2rem", border: "2px dashed #475569", borderRadius: "8px" }}>
                <p style={{ marginBottom: "1rem", opacity: 0.7 }}>No proof active. Upload a PDF to start the approval process.</p>
                <input 
                  type="file" 
